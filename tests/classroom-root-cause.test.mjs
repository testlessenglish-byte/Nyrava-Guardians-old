...
import { FOUNDATION_CERTIFICATE, FOUNDATION_MISSIONS, missions } from "../src/domain/progression/catalog.ts";
...
test("only one authoritative classroom scene renders and SecurityClassroomCorrection patch component is removed", () => {
  ...
  assert.equal(fs.existsSync(patchPath), false, "Patch component security-classroom-correction.tsx must be completely deleted.");
