...
export const GUARDIAN_DIALOGUES: Record<string, Record<LocaleId, GuardianDialogue>> = {
  lex: {
    "en-US": {
      ...
      intro: "You found the Data Arena! Here we analyze patterns, classify datasets, and evaluate AI answers.",
      askPermission: "AI can sound very confident even when it's wrong. Want to test if you can spot the pattern with me?",
      ...
      explainMore: "We'll check whether the AI's answer actually matches real evidence or if it's hallucinating.",
    ...
    "es-MX": {
      ...
      intro: "¡Llegaste a la Arena de Datos! Aquí analizamos patrones, clasificamos datos y evaluamos las respuestas de la IA.",
      askPermission: "La IA puede sonar muy segura de sí misma aunque esté equivocada. ¿Quieres poner a prueba tus dotes de detective de datos conmigo?",
      ...
      explainMore: "Revisaremos si las respuestas de la IA realmente coinciden con la evidencia real o si está inventando cosas.",
  ...
  nova: {
    "en-US": {
      ...
      intro: "Welcome to the Mystery Network! In this zone, we uncover misinformation and check sources.",
      askPermission: "I found something strange in this news story. Would you like to help me check if the sources are real?",
      ...
      explainMore: "We'll look at who wrote the claim, whether other reliable sources confirm it, and if images were altered.",
    ...
    "es-MX": {
      ...
      intro: "¡Te damos la bienvenida a la Red de Misterios! En esta zona descubrimos noticias falsas y verificamos fuentes.",
      askPermission: "Encontré algo muy raro en esta noticia. ¿Te gustaría ayudarme a revisar si las fuentes son reales?",
      ...
      explainMore: "Revisaremos quién escribió la nota, si otros sitios confiables la confirman y si la imagen fue cambiada por IA.",
  ...
  zoey: {
    "en-US": {
      greeting: "Welcome! I'm Zoey, the Protector.",
      intro: "You've entered the Privacy Shield Zone. We keep our personal info, passwords, and identity safe online.",
      askPermission: "Someone is asking for personal details in a public game room. Want to help activate the Privacy Shield?",
      ...
      explainMore: "You'll learn what information is safe to share with friends and what should always stay private.",
    ...
    "es-MX": {
      greeting: "¡Hola! Soy Zoey, la Protectora.",
      intro: "Entraste a la Zona del Escudo de Privacidad. Aquí cuidamos nuestra información personal y contraseñas.",
      askPermission: "Alguien está pidiendo datos personales en una sala pública. ¿Quieres ayudarme a activar el Escudo de Privacidad?",
      accept: "¡Escudos arriba! Protejamos a nuestros amigos y mantengamos las contraseñas seguras.",
      decline: "¡Cuídate mucho! Protegeré esta estación mientras exploras.",
      explainMore: "Aprenderás qué información se puede compartir con amigos y cuál debe mantenerse siempre privada.",
  ...
  jacob: {
    "en-US": {
      ...
      intro: "Welcome to the Builder District! Here we code robots, assemble AI workflows, and construct custom worlds.",
      askPermission: "My sorting robot needs new instructions to separate safe code from bugs. Want to try programming it?",
      ...
      explainMore: "We'll build step-by-step algorithms and debug robot choices using block or code instructions.",
    ...
    "es-MX": {
      ...
      intro: "¡Te damos la bienvenida al Distrito Constructor! Aquí programamos robots y construimos mundos con IA.",
      askPermission: "Mi robot ordenador necesita nuevas instrucciones para separar el código seguro de los errores. ¿Quieres programarlo conmigo?",
  ...
  dayana: {
    "en-US": {
      ...
      intro: "You found the Communication Realm! Here we learn digital kindness, empathy, and how algorithms spread messages.",
      askPermission: "A message is spreading fast on the network and causing confusion. Want to help restore friendly communication?",
      ...
      explainMore: "We'll look at how recommendation algorithms recommend posts and how to choose respectful communication.",
    ...
    "es-MX": {
      ...
      intro: "¡Llegaste al Reino de la Comunicación! Aquí aprendemos sobre empatía digital y cómo se difunden los mensajes.",
      askPermission: "Un mensaje se está compartiendo muy rápido y causa confusión. ¿Quieres ayudarme a difundir empatía y claridad?",
      ...
      explainMore: "Veremos cómo funcionan los algoritmos de recomendación y cómo comunicarnos con respeto.",
  ...
  sarah: {
    "en-US": {
      ...
      intro: "You've entered the Cyber Defense Zone! We defend against phishing, suspicious messages, and deepfake impersonation.",
      askPermission: "A suspicious email just hit the command center. Want to run a Scam Patrol investigation with me?",
      ...
      explainMore: "You'll learn how to inspect urgent links, verify sender domains, and stop phishing attacks.",
    ...
    "es-MX": {
      ...
      intro: "¡Entraste a la Zona de Ciberdefensa! Defendemos el sistema contra phishing, mensajes sospechosos y deepfakes.",
      askPermission: "Llegó un correo sospechoso al centro de mando. ¿Quieres hacer una investigación de Patrulla de Estafas conmigo?",
      ...
      explainMore: "Aprenderás a inspeccionar enlaces urgentes, verificar dominios y detener ataques de phishing.",
